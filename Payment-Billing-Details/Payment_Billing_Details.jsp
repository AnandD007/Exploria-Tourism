...
<head>
    ...
    <title>Booking_Payment Billing Details | Exploria</title>
...
<body style="background: #f4bfd1;">
	<%
		...
		rs = stmt.executeQuery("select MoP from transaction where BID = (select max(BID) from Booking)");
				while(rs.next())
				{
					ch = rs.getString(1);
		}
		...
		{
			ano = 0;
						rs = stmt.executeQuery("select Acc_No from transaction where BID = (select max(BID) from Booking)");
										while(rs.next())
										{
											ano = rs.getInt(1);
			}
            ...
            <div class="collapse navbar-collapse" id="navcol-2">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#">&nbsp;Places&nbsp;</a>
                        <div class="dropdown-menu"><a class="dropdown-item" href="..\Pune-Places\Pune_Places.html">Pune</a><a class="dropdown-item" href="..\Jaipur-Places\Jaipur_Places.html">Jaipur</a><a class="dropdown-item" href="..\Delhi-Places\Delhi_Places.html">Delhi</a><a class="dropdown-item" href="..\Pune-Places\Mumbai_Places.html">Mumbai</a></div>
                    </li>
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#">Account</a>
                        <div class="dropdown-menu"><a class="dropdown-item" href="..\Booking_User-Profile-Page\User_Profile_Page.jsp">My Profile</a><a class="dropdown-item" href="..\Login_Page\Login.html">Log Out</a></div>
                    </li>
                </ul>
            </div>
        </div>
    </nav>
    <h3 class="display-6 text-center" style="font-size: 30px;margin-top: 25px;">&nbsp; Latest Tickets Payment Details</h3>
    ...
    <div class="text-end d-flex d-xxl-flex justify-content-center justify-content-xxl-center" style="margin-bottom:300px;margin-top:20px;"><a class="btn btn-primary bg-danger bg-gradient border rounded-pill" role="button" style="width: 140px;margin-left: 10px;" onClick = "window.print()"><i class="fa fa-print"></i>&nbsp;Print Inovice</a><button class="btn btn-primary bg-success bg-gradient border rounded-pill" type="button" style="width: 160px;margin-left: 10px;"><strong><a href = "..\Home-Exploria\HomePage.html">Goto Back Home</a></strong></button></div>
    <footer class="footer-basic" style="background: var(--bs-gray-dark);color: var(--bs-light);margin-top: 20px;border-top-left-radius: 20px;border-top-right-radius: 20px;">
        ...
        <div class="social"><a href="#"><i class="icon ion-social-instagram"></i></a><a href="https://in.linkedin.com/"><i class="icon ion-social-linkedin"></i></a><a href="#"><i class="icon ion-social-twitter"></i></a><a href="https://www.facebook.com/"><i class="icon ion-social-facebook"></i></a></div>
